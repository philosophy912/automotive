## 版本更新说明
**V5.5.0**
- 在utils中增加了动态导入模块的方法， 新增了文件解压方法，支持zip，gz和tar

- 增加了Stress的直接导入，并修复了相关的错误，增加了相关的注释，增加了错误追踪代码

- 优化了部分代码，包含移除不必要的导入，增加部分代码的注释描述，

- 修复了dbc parser中的相关错误

- 修改了panel的一些方法，如增加恢复信号输入框，函数名称自动生成方式等

- 修复了xmind转excel的相关错误

- 新增了UDS模块，可以通过CAN盒进行诊断测试

- 增加了logger中打开yml文件的容错处理

- 优化了ctypes导入动态链接库的方式

- 优化了images类，使用最新的airtest库

- 增加了can service的with方法调用， 并将随机信号加入线程池中执行

- 新增了android service中图找图点击，查找等方法
